...
const Resume = () => {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <div className='text-center shadow-2xl shadow-teal-600 p-10 rounded-xl my-10 dark:shadow-teal-500'>
      ...
      <div className='text-center shadow-2xl  shadow-teal-600 p-10 rounded-xl my-10 dark:shadow-teal-500'>
        ...
        <p className='text-gray-800 py-1  dark:text-white'>• Docker</p>
          ...
          <div className="pt-10 flex flex-col items-start  relative pb-16 md:pl-8">
          <div>
              <img src="../images/branch.png" alt="branches" className='absolute opacity-10 ml-12 
              ' />
              </div>
            <h3 className="text-2xl py-2 text-black font-bold mt-12 mb-6 md:text-2xl dark:text-white">Experience</h3>
            <p>NOV 2022</p>
            <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl">LIA | Sudo Sweden (24 weeks)</h2>
            ...
            <div className="pt-12 flex flex-col items-start">
              ...
              <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl">IT Consultant | Phantoms</h2>
              <ul className="flex flex-col items-start mt-6">
            ...
            <div className=" flex flex-col items-start pt-12">
              <p>APRIL 2013 - 2017</p>
              <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl ">Sales | Åhlens Linköping</h2>
              <ul className="flex flex-col items-start mt-6">
                <li>• Cashier, visual merchandiser</li>
                <li className='mb-12'>• Sales oriented and customer focus</li>
              </ul>
            </div>
            ...
            <h3 className="text-2xl py-2 text-black font-bold mt-12 mb-6 md:text-2xl dark:text-white">Education</h3>
              ...
              <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl">
              Frontend Development | 2 Years</h2>
              <p>Jensen Education, focus on websecurity</p>
              
              <h3 className="text-2xl py-2 text-black font-bold mt-12 mb-6 md:text-2xl dark:text-white">
                Skills & Interests
              </h3>
              <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl">Skills:</h2>
              <p>JavaScript, ReactJS, Bootstrap, HTML/CSS, Tailwind, Node.js, Express.js, Git, REST.API, 
              ...
              <p>English - Fluent</p>
              <p>Arameic - Native Language</p>
              <h2 className="text-3xl py-2 text-teal-600 font-bold md:text-3xl mt-12">Interests:</h2>
              <p className="">Sustainability, coding, music, design, make-up, cinema, travelling, nature.</p>
